        ...
        <el-form-item label="标签" prop="tag">
          <el-select v-model="form.tag" placeholder="请选择标签类型">
            <el-option label="蓝色" value="primary">
              ...
              <span style="float: right; color: #409eff;"><i class="icon icon-tag"></i></span>
            </el-option>
            <el-option label="绿色" value="success">
              <span style="float: left">绿色</span>
              <span style="float: right; color: #67c23a;"><i class="icon icon-tag"></i></span>
            </el-option>
            <el-option label="灰色" value="info">
              <span style="float: left">灰色</span>
              <span style="float: right; color: #909399;"><i class="icon icon-tag"></i></span>
            </el-option>
            <el-option label="黄色" value="warning">
              <span style="float: left">黄色</span>
              <span style="float: right; color: #e6a23c;"><i class="icon icon-tag"></i></span>
            </el-option>
            <el-option label="红色" value="danger">
              <span style="float: left">红色</span>
              <span style="float: right; color: #f56c6c;"><i class="icon icon-tag"></i></span>
            </el-option>
          </el-select>
        </el-form-item>        
